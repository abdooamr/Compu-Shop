...
public partial class ContactUs : System.Web.UI.Page
{
    ...
    protected void btnSend_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SmtpClient smtpClient = new SmtpClient("smtp.yourprovider.com"); // Replace with your SMTP server
            smtpClient.Port = 587; // Replace with your SMTP port
            smtpClient.Credentials = new NetworkCredential("your_email@example.com", "your_password"); // Replace with your credentials
