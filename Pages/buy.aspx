<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeFile="/Pages/buy.aspx.cs" Inherits="buy" %>
    ...
    <section class="contact_section layout_padding">
        ...
        <div class="product-container">
            ...
            <div class="product-details">
                ...
                <div>
                    <label></label>
                    <asp:Label ID="lblProductStock" runat="server" Text=""></asp:Label>
